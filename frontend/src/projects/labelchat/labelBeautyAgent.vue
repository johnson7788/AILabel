...
import { getPrompts, startLabelChat, saveChat, getTools, getAllQuestion, queryQuestionLabel,appendQuestion } from './api.ts'
...
async function Auto() {
    ...
    const res = await axios.post(
        ...
        { "workflow": true, "fake": true, "project": "beauty" },
    )
    console.log(res)
    const data = res.data
    const msg = data.msg
...
async function AnswerQuestion() {
    ...
    const res = await axios.post(
        ...
        { "messages": messages.value, "workflow": workflow, "project": "beauty" },
    )
