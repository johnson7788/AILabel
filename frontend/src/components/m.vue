            ...
            <div class="bg-gray-700 p-4 rounded-lg">
              <div class="flex items-center space-x-2">
                ...
                <div class="relative">
                  ...
                  <!-- Waveform Animation -->
                  <div v-if="isRecording" class="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-cyan-500 to-blue-500 animate-pulse">
...
const updateWaveform = () => {
  if (analyser && dataArray) {
    ...
    if (waveform) {
      waveform.style.height = `${average / 2}px`; // Adjust height based on average sound intensity
    }
