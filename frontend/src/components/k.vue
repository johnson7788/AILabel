          ...
          <div class="mt-8">
            <div class="bg-gray-700 p-4 rounded-lg">
              <div class="flex items-center space-x-2">
                ...
                <button @click="startRecording" :disabled="!isConnected" class="text-blue-500">
...
const connectWebSocket = () => {
  websocket = new WebSocket('ws://your-backend-url');
...
const startRecording = async () => {
  try {
    ...
    // Handle audio recording and sending here
  } catch (error) {
